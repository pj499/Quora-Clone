...
import { faHouse, faBarsStaggered, faUserGroup, faPen, faBell, faMagnifyingGlass, faGear, faRightFromBracket } from "@fortawesome/free-solid-svg-icons";
                ...
                <div className={styles.NavbarContentDiv}>
                    ...
                    <div className={styles.profilePicture} >
                        <img src={auth.user.avatar} alt=""
                            ...
                            onClick={() => { props.handleProfileDropDown() }}>
                        </img>
                        
                    </div>
                    {props.profileDropDown && <div className={styles.profileDropDown}>
                            <div className={styles.dropDownProfilePic}>
                                <img src={auth.user.avatar} alt=""
                                    referrerpolicy="no-referrer"
                                    style={{ width: '45px', height: '45px', borderRadius: '50px' }}>
                                </img>
                                <h3 style={{marginTop:"5px",fontSize:"18px",lineHeight:"25px",fontWeight:"700",fontFamily:"Cantarell, Helvetica Neue, sans-serif"}}>{auth.user.name}</h3>
                            </div>
                            <div className={styles.dropDownItems}>
                                <div className={styles.dropDownItemsItem}>
                                    <p style={{fontSize:'16px', margin:'0px', fontFamily:"Cantarell, Helvetica Neue, sans-serif"}}> <FontAwesomeIcon icon={faGear} size='lg' style={{color:'#282829'}}/> &nbsp;Settings</p>
                                </div>
                                <div className={styles.dropDownItemsItem}>
                                    <p style={{fontSize:'16px', margin:'0px', fontFamily:"Cantarell, Helvetica Neue, sans-serif"}} onClick={handleLogout}> <FontAwesomeIcon icon={faRightFromBracket} size='lg' style={{color:'#282829'}}/> &nbsp;Logout</p>
                                </div>
                            </div>
                        </div>}
                    <button type="button" className={styles.addQuestion} onClick={props.handleIsAddQuestion}>Add Question</button>
